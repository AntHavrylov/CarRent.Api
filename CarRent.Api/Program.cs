...
}).AddJwtBearer(x => 
{
    ...
    {
        // Normally key is saved in proper secrets manager
        // here key store just for simplify demo
...
builder.Services.AddValidatorsFromAssemblyContaining<CarRentApiMarker>(ServiceLifetime.Singleton);
